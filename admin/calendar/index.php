...
?>
<?php
// Inline extra styles for the calendar grid
?>
<style>
...
.cal-cell.today .cal-day-num { background:#1d4ed8; color:#fff; width:22px; height:22px; border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:11px; }
...
<div class="card">
    ...
    <div class="cal-grid">
        ...
        for ($day = 1; $day <= $days_in_month; $day++) {
            ...
            if ($is_today) {
                echo '<div class="cal-day-num" style=""><span style="background:#1d4ed8;color:#fff;width:22px;height:22px;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;font-size:11px">' . $day . '</span></div>';
            } else {
