<script src="/admin/assets/js/admin-common.js?v=10"></script>
<?php if ($tab === 'cursuri'): ?>
<script src="/admin/assets/js/admin-course-form.js?v=4"></script>
...
<script src="/admin/assets/js/admin-speakeri.js?v=7"></script>
