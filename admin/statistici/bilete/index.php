...
<header class="app-header">
  ...
  <div class="header-controls">
    <a href="/admin/statistici/" class="logout-link">&larr; CLP</a>
...
<main class="container">
  <div class="bilete-wrap">
    <h2>C&acirc;te bilete s-au v&acirc;ndut per comand&#x103;?</h2>
    <p class="lead">&Icirc;ncarc&#x103; exportul XLSX de pe Livetickets &#x219;i prime&#x219;ti instant distribu&#x21B;ia comenzilor.</p>
    ...
    <!-- Column picker (apare dupa parsare daca e neclar) -->
    ...
    <div class="result-card" id="resultCard">
      ...
      <button class="reset-btn" id="btnReset">&larr; &Icirc;ncarc&#x103; alt fi&#x219;ier</button>
    </div>
  </div>
</main>
