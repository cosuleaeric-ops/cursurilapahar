        ...
        <div class="footer-inner">
            ...
            <div class="footer-social">
                ...
                <a href="https://cesaicumpar.ro/" target="_blank" rel="noopener" aria-label="Ce să îi cumpăr">
                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 7h-1.31A3.49 3.49 0 0019 5.5 3.5 3.5 0 0015.5 2c-1.4 0-2.6.83-3.16 2.02L12 4.62l-.34-.6A3.49 3.49 0 008.5 2 3.5 3.5 0 005 5.5c0 .55.13 1.06.31 1.5H4a2 2 0 00-2 2v2a1 1 0 001 1h8V7h2v4h8a1 1 0 001-1V9a2 2 0 00-2-2zm-11.5 0a1.5 1.5 0 110-3c.83 0 1.5.67 1.5 1.5V7H8.5zm7 0H14V5.5c0-.83.67-1.5 1.5-1.5a1.5 1.5 0 110 3zM4 13v7a2 2 0 002 2h5v-9H4zm9 9h5a2 2 0 002-2v-7h-7v9z"/></svg>
                </a>
            </div>
        </div>
