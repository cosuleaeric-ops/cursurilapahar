...
if (file_exists(EVENTS_FILE)) {
    ...
    if (is_array($raw)) {
        $events = array_filter($raw, fn($e) => !empty($e['active']));
        usort($events, fn($a, $b) => strtotime($a['date_raw'] ?? '9999') - strtotime($b['date_raw'] ?? '9999'));
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Cursuri la Pahar – Cursuri ținute de experți, la un pahar în oraș</title>
    <meta name="description" content="Cursuri ținute de experți într-un cadru relaxat, la un pahar în oraș. Descoperă următoarele teme și rezervă-ți locul.">
    <meta property="og:title" content="Cursuri la Pahar">
    <meta property="og:description" content="Cursuri ținute de experți, la un pahar în oraș.">
...
<section class="section" id="cursuri">
    <div class="container">
        ...
        <div class="events-grid">
            ...
            <a href="<?= htmlspecialchars($ev['url']) ?>" target="_blank" rel="noopener" class="event-card">
                <div class="event-card-img">
                    ...
                    <div class="event-card-date-badge">
                        <span class="badge-day"><?= date('d', strtotime($ev['date_raw'])) ?></span>
                        <span class="badge-month"><?= strtoupper(strftime('%b', strtotime($ev['date_raw']))) ?></span>
                    </div>
                </div>
...
<section class="section" id="colaborare">
    <div class="container">
        ...
        <div class="collab-grid">
            <a href="colaborare/sustine-un-curs.php" class="collab-card">
            ...
            <a href="colaborare/gazduieste-un-curs.php" class="collab-card">
                <div class="collab-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><path d="M9 22V12h6v10"/></svg>
                </div>
            ...
            <a href="colaborare/propune-un-parteneriat.php" class="collab-card">
                <div class="collab-icon">
...
<footer class="footer">
    <div class="container">
        ...
        <div class="footer-bottom">
            <p>&copy; <?= date('Y') ?> Cursuri la Pahar. Toate drepturile rezervate.</p>
        </div>
    </div>
</footer>
