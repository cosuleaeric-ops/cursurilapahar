...
/** Sesiunile mele nu intră în statistici: marcajul nesecret ținut sincron cu sesiunea din proxy.ts, același pe care îl citește AdminBar. */
function eAdmin(): boolean {
  return document.cookie.split(";").some((c) => c.trim().startsWith("clp_bar="))
}
