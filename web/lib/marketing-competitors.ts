...
export const DEFAULT_MARKETING_COMPETITORS: MarketingCompetitor[] = [
...
export function normalizeMarketingCompetitors(value: unknown): MarketingCompetitor[] | null {
  ...
  return value
    ...
    .filter((item): item is MarketingCompetitor => item !== null);
}

export function marketingCompetitorsFromSetting(value: unknown): MarketingCompetitor[] {
  return normalizeMarketingCompetitors(value) ?? DEFAULT_MARKETING_COMPETITORS;
}
